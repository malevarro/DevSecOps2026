    ...
    - [2.3 – Activar y revisar](#23--activar-y-revisar)
      ...
      - [Instalación de Extensiones en Visual Studio Code](#instalación-de-extensiones-en-visual-studio-code)
        - [Configuraciones de las extensiones](#configuraciones-de-las-extensiones)
          ...
          - [Análisis con Checkov (CheckovPrismaless)](#análisis-con-checkov-checkovprismaless)
          - [Activación y análisis con Qwiet preZero](#activación-y-análisis-con-qwiet-prezero)
...
###### Análisis con Checkov (CheckovPrismaless)
...
1. Verifique que la extensión haya sido instalada correctamente, para ello verifique en la parte inferior derecha del Visual Studio Code que aparezca Checkov con la versión indicada.

    ![CheckovV2Act1](./Images/CheckovV2Act1.png)

2. Vaya a la lista de archivos que componen la aplicación y abra el archivo de Dockerfile

    ![CheckovV2Act2](./Images/CheckovV2Act2.png)

3. Abra la ventana de ejecución de comandos de Visual Studio Code con la siguiente combinación de teclas __Ctrl+Shift+P__ y ejecute el comando __Checkov scan__

    ![CheckovV2Act3](./Images/CheckovV2Act3.png)

4. En la parte inferior izquierda al lado de indicativo de la versión de Checkov aparecen iconos que resaltan los resultados con símbolos de error o de advertencia. haga click sobre ellos para ver la ventana de alertas e identificar los hallazgos presentados por la herramienta

    ![CheckovV2Act4](./Images/CheckovV2Act4.png)

5. Si requiere más detalle del evento presentado puede dar click sobre el enlace presentado en el error, este enlace lo redirige a una página web que contiene la explicación del error.

    ![CheckovV2Act5](./Images/CheckovV2Act5.png)

###### Activación y análisis con Qwiet preZero

Para hacer uso de la extensión de __Qwiet preZero__ es necesario realizar los siguientes pasos luego de realizar la instalación:

1. Haga click en el ícono de __Qwiet preZero__ que ahora se ubica en la barra lateral izquierda
2. Haga Click en el botón de *Connect to Qwiet preZero*

    ![Shiftv2Act1](./Images/Shiftv2Act1.PNG)
...
8. En el recuadro de comandos escribimos *analyze* y seleccionamos la opción relacionada con ShiftLeft
    ...
    ![ShiftAct7V2](./Images/ShiftAct7V2.PNG)
