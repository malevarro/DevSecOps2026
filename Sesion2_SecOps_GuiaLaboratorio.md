...
> **Curso:** SecOps – Seguridad en Nubes Públicas
...
- [Paso 1 – Resource Group](#paso-1--creación-del-resource-group)
- [Paso 2 – VNet Hub](#paso-2--creación-de-la-vnet-hub)
- [Paso 3 – VNets Spoke](#paso-3--creación-de-las-vnets-spoke)
- [Paso 4 – Máquinas virtuales Linux](#paso-4--despliegue-de-máquinas-virtuales-linux)
- [Paso 5 – VNet Peering](#paso-5--configuración-de-vnet-peering-hub--spokes)
- [Paso 6 – NSG por subred](#paso-6--configuración-de-nsg-por-subred)
- [Paso 7 – Instalación de Zentyal Server](#paso-7--instalación-y-configuración-de-zentyal-server)
- [Paso 8 – Firewall en Zentyal](#paso-8--configuración-del-firewall-en-zentyal)
- [Paso 9 – IDS/IPS en Zentyal (Suricata)](#paso-9--configuración-del-idsips-en-zentyal-suricata)
- [Paso 10 – Enrutamiento (UDR)](#paso-10--enrutamiento-udr-para-forzar-tráfico-a-través-de-zentyal)
- [Paso 11 – nmap y netcat en las VMs Spoke](#paso-11--instalación-de-nmap-y-netcat-en-las-vms-spoke)
- [Paso 12 – Pruebas de detección IDS/IPS](#paso-12--pruebas-de-detección-por-el-idsips-de-zentyal)
...
- [Paso 14 – Base de datos (tier de datos, Spoke2)](#paso-14--desplegar-la-base-de-datos-tier-de-datos-spoke2)
- [Paso 15 – App Service y Function App (tier de aplicación, Spoke1)](#paso-15--desplegar-app-service-y-function-app-tier-de-aplicación-spoke1)
...
- [Paso 17 – Validación de la microsegmentación](#paso-17--validación-de-la-microsegmentación-zentyal--network-watcher)

**Parte III – CSPM con CloudSploit**
- [Paso 18 – CloudSploit desde Azure Cloud Shell](#paso-18--cspm-con-cloudsploit-desde-azure-cloud-shell)
